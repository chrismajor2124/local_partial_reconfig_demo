...
HD_PWD='D:/Xilinx/local_PR_test_01/local_PR_test_01.runs/mb_pr_01_axi_hwicap_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_pr_01_axi_hwicap_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_pr_01_axi_hwicap_0_0.tcl
