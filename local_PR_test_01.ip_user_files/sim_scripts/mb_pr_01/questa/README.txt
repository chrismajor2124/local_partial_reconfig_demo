...
#
# Generated by export_simulation on Fri Apr 16 13:30:55 -0600 2021
#
################################################################################
...
'-reset_run' switch to the './mb_pr_01.sh' script.

./mb_pr_01.sh -reset_run
...
./mb_pr_01.sh -noclean_files

For more information on the script, please type './mb_pr_01.sh -help'.
