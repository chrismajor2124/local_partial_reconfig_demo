...
#
# Generated by Vivado on Tue Apr 13 16:49:14 -0600 2021
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_pr_01.protoinst" -log simulate.log
}
