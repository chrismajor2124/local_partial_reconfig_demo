...
#
# Generated by Vivado on Tue Mar 16 16:00:39 -0600 2021
...
# Script info
echo -e "sem_0.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L sem_v4_1_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sem_0 xil_defaultlib.sem_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sem_0 -key {Behavioral:sim_1:Functional:sem_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_pr_01.protoinst" -log simulate.log
}
